...
var unban_exports = {};
__export(unban_exports, {
  default: () => unban_default
});
module.exports = __toCommonJS(unban_exports);
var import_telegram = require("telegram");
var import_chk = __toESM(require("../helpers/chk"));
const unmute = async (client, e, upt) => {
  const y = new import_chk.default(client, e);
  try {
    const m = e.message;
    let user = await y.chk();
